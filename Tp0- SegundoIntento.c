...
int main(){
    ...
    /***
    fuerza_psiquica==valor_animo*numero_nivel_confianza;
    printf("%f Resultado fuerza psiquica \n", fuerza_psiquica);
   
    if (fuerza_psiquica<65){
        printf ("Resultadoes desconocido\n");
        ...
        printf ("Jugador ataque certero\n");
        printf ("Jugador debilitado\n");
